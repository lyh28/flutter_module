...
//推荐页
class HomePagePush extends StatefulWidget {
  HomePagePush({Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return HomePagePushState();
  }
}

class HomePagePushState extends State<HomePagePush> {
  ...
  void init() {
    ...
    Beans.initPushLine().then((e) {
      if (!Beans.checkNull()) setState(() {});
    });
    Beans.initButton().then((e) {
      if (!Beans.checkNull()) setState(() {});
    });
//    Beans.initOfficial().then((e) {
//      if (!Beans.checkNull()) setState(() {});
//    });
    Beans.personindex = 4;
  }
      ...
      child: Center(
        ...
        Padding(
          ...
          child: FadeInImage.assetNetwork(
            placeholder: "images/defaulticon.jpg",
            image: icon,
            width: 35,
            height: 35,
            fit: BoxFit.fill,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Text(Beans.pushLineList[index].subTitle,
